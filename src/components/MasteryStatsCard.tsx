  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-4 gap-2 text-center">
        ...
        <div>
          <div className="text-2xl font-bold text-red-400">{snapshot.leech}</div>
          <div className="text-xs text-neutral-500">Leech</div>
        </div>
      </div>
      ...
      <div className="pt-2 border-t border-neutral-800">
        <div className="flex justify-between text-sm">
          <span className="text-neutral-400">Reviewed Problems</span>
          <span className="text-neutral-300 font-medium">{reviewedTotal}</span>
        </div>
      </div>
    </div>
  );
